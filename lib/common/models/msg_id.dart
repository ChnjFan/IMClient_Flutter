class MsgId {
  ...
  static const int deleteFriendReq = 2015;
  static const int deleteFriendRsp = 2016;
  ...
  static const int updateConvMessageStatusReq = 4007;
  static const int updateConvMessageStatusRsp = 4008;
